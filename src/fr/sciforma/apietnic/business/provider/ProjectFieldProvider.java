...
//        fields.add(SciformaField.builder().name("Début réel").type(FieldType.DATE).build());
        ...
        fields.add(SciformaField.builder().name("Ecart charge").type(FieldType.DECIMAL).build());
        fields.add(SciformaField.builder().name("ecart charge_FCS").type(FieldType.EFFORT).build());
        ...
        fields.add(SciformaField.builder().name("Ecart duree FCS").type(FieldType.DURATION).build());
        ...
        fields.add(SciformaField.builder().name("Valeur acquise FCS").type(FieldType.COST).build());
...
//        fields.add(SciformaField.builder().name("Y_Etat demande ou projet").type(FieldType.STRING).build());
        fields.add(SciformaField.builder().name("Y_Etat demande projet").type(FieldType.STRING).build());
...
//        fields.add(SciformaField.builder().name("Y_Statut demande ou projet").type(FieldType.STRING).build());
    }
